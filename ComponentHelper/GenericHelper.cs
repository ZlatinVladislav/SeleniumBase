...
namespace SeleniumWebdriver.ComponentHelper
{
    ...
    {
        public static WebDriverWait wait = new WebDriverWait(ObjectRepository.Driver, TimeSpan.FromSeconds(ConfigClass.ElementLoadTimeout));
        ...
        {
            WaitForWebElement(locator, "Multiple Elements");
        ...
        {
            WaitForWebElement(locator, "Single Element");
        ...
        public static bool WaitForWebElement(By locator, string elementName)
        {
            try
            {
        ...
        public static void DragAndDrop(By locatorSrc, By locatorTar , string elementName)
        {
            try
            {
                WaitForWebElement(locatorSrc, elementName);
                WaitForWebElement(locatorTar, elementName);
        ...
        public static void moveMousePointer(By locator, string elementName)
        {
            try
            {
                WaitForWebElement(locator, elementName);
                Actions act = new Actions(ObjectRepository.Driver);
